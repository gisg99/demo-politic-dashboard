...
function Economia() {
    ...
    const intereses = [
        { label: 'Mercado Laboral', count: 70 },
        { label: 'Comercio Justo', count: 95 },
        { label: 'Transparencia', count: 65 },
        { label: 'Manejo de Recursos', count: 70 },
        { label: 'Obras Públicas', count: 65 },
        { label: 'Becas / Apoyos', count: 90 }
    ];
