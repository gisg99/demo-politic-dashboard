...
function MedioAmbiente() {
    ...
    const edadDataRaw = [
    { label: '18-25', value: 9, color: '#E0E0E0' },
    { label: '26-34', value: 19, color: '#BDBDBD' },
    { label: '34-44', value: 25, color: '#FFC107' },
    { label: '45-54', value: 20, color: '#FFB74D' },
    { label: '55-64', value: 17, color: '#FF9800' },
  ...
  return (
    <div className='flex flex-col w-full gap-3 sm:gap-4 p-2 sm:p-0'> 
        ...
        <div className='w-full'>
            <Card title="Percepción Ciudadana en Medio Ambiente">
                <div className='flex flex-col w-full items-end'>
                    ...
                    {intereses.map((tema, index) => (   
                        ...
                        <div className='flex group gap-1 sm:gap-2 w-full items-center justify-end px-1 sm:px-3'>
                            <h1 className='text-gray-500 mr-2 sm:mr-12 text-xs sm:text-base lg:text-lg text-right flex-shrink-0 w-24 sm:w-auto'>{tema.label}</h1>
                            <div className='w-[70%] sm:w-[75%] h-3 sm:h-4 rounded-xs' style={{ background: `linear-gradient(90deg,rgb(255, 145, 77) 0%,rgb(255, 196, 160) ${tema.count}%, rgb(215, 215, 215, 0.8) ${tema.count}%, rgb(215, 215, 215, 0.8) 100%)`}}>
