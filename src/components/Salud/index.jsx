...
function Salud({data}) {
    ...
    const intereses = [
        { label: 'Hospitales', count: parseFloat(data[0].promedio)*20 },
        { label: 'Equipo Hospitalario', count: parseFloat(data[1].promedio)*20 },
        { label: 'Medicamentos', count: parseFloat(data[2].promedio)*20 },
        { label: 'Atención Urgencias', count: parseFloat(data[3].promedio)*20 },
        { label: 'Atención Médica Gral.', count: parseFloat(data[4].promedio)*20 },
        { label: 'Bancos de Sangre', count: parseFloat(data[5].promedio)*20 }
    ];

    const nivelSocioeconomicoData = [
        { label: 'A/B', value: 25, color: '#9CA3AF' },
        { label: 'C+', value: 5, color: '#FED7AA' },
        { label: 'C', value: 30, color: '#FDBA74' },
        { label: 'C-', value: 20, color: '#FB923C' },
        { label: 'D/E', value: 20, color: '#F97316' }
    ];
    // Datos para el gráfico de Género
    const generoData = [
    { label: 'Masculino', value: 66.1, color: '#FFB74D' },
    { label: 'Femenino', value: 33.9, color: '#FF8A65' }
    ];

    const edadDataRaw = [
        { label: '18-25', value: 10, color: '#E0E0E0' },
        { label: '26-34', value: 20, color: '#BDBDBD' },
        { label: '34-44', value: 26, color: '#FFC107' },
        { label: '45-54', value: 18, color: '#FFB74D' },
        { label: '55-64', value: 16, color: '#FF9800' },
  ...
  return (
    <div className='flex flex-col w-full gap-3 sm:gap-4 p-2 sm:p-0'> 
        ...
        <div className='w-full'>
            <Card title="Percepción Ciudadana en Salud">
