    ...
    <div className="flex flex-col items-center justify-center relative">
      <div className="p-2 max-w-md w-full">
        ...
        <div className="flex justify-center relative">
          ...
          {/* Tooltip */}
          {hoveredSegment && (
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black bg-opacity-80 text-white px-3 py-2 rounded-lg text-sm font-medium pointer-events-none z-10">
