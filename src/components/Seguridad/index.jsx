...
function Seguridad({data}) {
    ...
    const intereses = [
        { label: 'Prevención del Delito', count: parseFloat(data[0].promedio)*20 },
        { label: 'Convivencia Pacífica', count: parseFloat(data[1].promedio)*20 },
        { label: 'Atn. a Emergencias', count: parseFloat(data[2].promedio)*20 },
        { label: 'Protección Der. Hum.', count: parseFloat(data[3].promedio)*20 },
        { label: 'Justicia Eficaz', count: parseFloat(data[4].promedio)*20 },
        { label: 'Corrupción', count: parseFloat(data[5].promedio)*20 }
    ];
    ...
    const generoData = [
    { label: 'Masculino', value: 60.4, color: '#FFB74D' },
    { label: 'Femenino', value: 39.6, color: '#FF8A65' }
    ];

    const edadDataRaw = [
    { label: '18-25', value: 15, color: '#E0E0E0' },
    { label: '26-34', value: 18, color: '#BDBDBD' },
    { label: '34-44', value: 24, color: '#FFC107' },
    { label: '45-54', value: 19, color: '#FFB74D' },
    { label: '55-64', value: 14, color: '#FF9800' },
  ...
  return (
    <div className='flex flex-col w-full gap-3 sm:gap-4 p-2 sm:p-0'> 
        ...
        <div className='w-full'> 
            <Card title="Percepción Ciudadana en Seguridad">
