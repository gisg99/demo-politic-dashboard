...
function Seguridad() {
    ...
    const intereses = [
        { label: 'Prevención del Delito', count: 95 },
        { label: 'Convivencia Pacífica', count: 60 },
        { label: 'Atn. a Emergencias', count: 40 },
        { label: 'Protección Der. Hum.', count: 80 },
        { label: 'Justicia Eficaz', count: 60 },
        { label: 'Corrupción', count: 95 }
    ];
