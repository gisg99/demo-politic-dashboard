...
function Educacion() {
    ...
    const intereses = [
        { label: 'Acceso a la Educación', count: 60 },
        { label: 'Calidad Educativa', count: 85 },
        { label: 'Formación Docente', count: 35 },
        { label: 'Acceso a Tecnología', count: 80 },
        { label: 'Apoyo a Alumnos', count: 45 },
        { label: 'Educación Inclusiva', count: 90 }
    ];
